function PageIntro({ eyebrow, title, description }) {
  return (
    <section className="mx-auto max-w-[1240px] px-4 pt-8 sm:px-5 sm:pt-14">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 to-slate-700 px-5 py-8 text-white sm:rounded-3xl sm:px-10 sm:py-10">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <h1 className="font-heading text-[clamp(1.8rem,4vw,3.4rem)] leading-[0.95] font-bold">
            {title}
          </h1>
