...
function HeroSection() {
  ...
  return (
    <section
      className="relative isolate flex min-h-[100svh] items-end overflow-hidden bg-[#0a0a0a] sm:min-h-[64vh] lg:min-h-[78vh]"
      data-aos="zoom-out"
    >
      <img
      ...
      <div
        className="relative z-10 mx-auto w-full max-w-[1240px] px-4 pb-20 sm:px-5 sm:pb-12 lg:-translate-x-6 xl:-translate-x-25"
        data-aos="fade-up"
        data-aos-delay="120"
      >
